        ...
        <div class="bg-white">
          <div class="lg:flex">
            <div class="m-2 border relative border-gray-200 rounded-md">
              ...
              <div @click="updateInfo" class="absolute top-3 cursor-pointer right-3">
            ...
            <div class="m-2 lg:w-full">
              <div class="lg:flex">
                <div class="
                  ...
                  <label for="fileInput">
                    <div v-if="imageURL === null && avatar === null" class="w-20 rounded-full bg-blue-100 h-20">
                      <img src="/icons/user.svg" class="mx-auto my-auto" alt="" />
                    </div>
                    <img v-else :src="imageURL || avatar" class="w-20 h-20 rounded-full" alt="" />
                  </label>
                  <input type="file" id="fileInput" @change="updatePhoto" class="hidden" />
                </div>
                <div class="
                      lg:w-1/2
                      top
                  ...
                  <textarea class="w-full p-1 bg-gray-200 h-full rounded-md" name=""
                    v-model="delivery_address"></textarea>
                </div>
              </div>
              ...
              <div class="relative">
                ...
                <div @click="updateLocation" class="absolute top-3 cursor-pointer right-3">
                  <img class="w-4 h-4" src="/save.png" alt="" />
                </div>
                <input type="text" class="py-2 border border-gray-200 pl-20 w-full" v-model="location" />
              </div>
            </div>
          </div>
        </div>
