  ...
  <div class="bg-gray-50 h-screen">
    ...
    <!-- <div class="max-w-screen-2xl mx-auto px-5 lg:flex mt-4 container mx-auto min-h-[calc(100vh-470px)]">
      <div v-show="sidebar" class="
            ...
            h-full
          ">
        <input type="text" class="bg-gray-100 p-3 w-full rounded-md" placeholder="Search a message" />
        <div v-if="single === undefined">
          <div v-for="(single, index) in list" :key="index" class="cursor-pointer">
            <div class="flex py-4" @click="singleMessage(single.messaging_id, index)">
              <img v-if="single.sender.avatar === null" src="/user.png" alt="" />
              <img v-else :src="single.sender.avatar" class="w-12 h-12 rounded-full" alt="" />
        ...
        <div>
          <div v-if="chats !== null">
            <div class="flex py-4">
              ...
              <img v-else :src="sender.avatar" class="w-12 h-12 rounded-full" alt="" />
              <div class="ml-3">
            ...
            <div v-for="(chat, index) in chats" :key="index">
              <div v-if="chat.sender === user.id" class="lg:w-2/3 mr-auto flex my-5">
          ...
          <div v-if="single !== undefined || chats !== null" class="w-full relative">
            <input type="text" class="p-3 w-full bg-gray-100 rounded-md" placeholder="Type a message" v-model="message" />
            <div class="flex absolute top-1 right-4">
              <img @click="sendMessage" class="p-2 cursor-pointer" src="/icons/send.svg" alt="" />
